...
func (*AppServerRunner) ApplyPatchApproval(context.Context, appproto.ApplyPatchApprovalParams) (*appproto.ApplyPatchApprovalResponse, error) {
	return nil, errors.New("apply patch approval is not configured")
}

func (*AppServerRunner) ExecCommandApproval(context.Context, appproto.ExecCommandApprovalParams) (*appproto.ExecCommandApprovalResponse, error) {
	return nil, errors.New("exec command approval is not configured")
}

func (*AppServerRunner) ItemCommandExecutionRequestApproval(context.Context, appproto.CommandExecutionRequestApprovalParams) (*appproto.CommandExecutionRequestApprovalResponse, error) {
	return nil, errors.New("command execution approval is not configured")
}

func (*AppServerRunner) ItemFileChangeRequestApproval(context.Context, appproto.FileChangeRequestApprovalParams) (*appproto.FileChangeRequestApprovalResponse, error) {
	return nil, errors.New("file change approval is not configured")
}

func (*AppServerRunner) ItemPermissionsRequestApproval(context.Context, appproto.PermissionsRequestApprovalParams) (*appproto.PermissionsRequestApprovalResponse, error) {
	return nil, errors.New("permissions approval is not configured")
}
...
func (*AppServerRunner) McpServerElicitationRequest(context.Context, appproto.McpServerElicitationRequestParams) (*appproto.McpServerElicitationRequestResponse, error) {
	return nil, errors.New("mcp elicitation is not configured")
}
